...
| `2026-09-26_definition_subsession.sql` | Item tabs from the chart in order Orientation, Definition, Subsession (`sort_order` on `dim_qualifier_set`). Definition (13) holds Consciousness, Physiology, Emotions, 5 Elements, 5 Senses, Other System (from the owner's photo of the chart; the last word is cut at the photo edge, to confirm). Subsession (14) empty until the owner gives its contents. Applied to production on 2026-09-26. |
| `2026-09-26_orientation_items.sql` | Orientation (12) gets the chart's 11 entries, `12.1`–`12.11`: Time, Person, Place, Object, Activity, Event, Animal, Plant, Work, Money, Emotions (owner's photo of the Orientation box). Applied to production on 2026-09-26. |
| `2026-09-26_workbook_part_labels.sql` | Workbook labels lead with the lesson range so lessons 221–365 are easy to find: "Part I · Lessons 1 to 220", "Part II · Lessons 221 to 365", and each Part II group "Lessons a to b · N. Title". Also removes 10.1.3.301–365, added by mistake under Forgiveness › Workbook › 300. Applied to production on 2026-09-26. |
